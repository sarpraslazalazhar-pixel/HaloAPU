...
import { FolderOpen, Loader2, RotateCw, CheckCircle2, XCircle, PlusCircle, History, Star, Monitor, ArrowRight, Ticket } from 'lucide-react';
...
export default function Dashboard({ recentTickets = [], stats }: { recentTickets?: any[], stats?: any }) {
    ...
    const STATUS_CARDS = [
        ...
        { label: 'Sedang Diproses', icon: RotateCw, count: stats?.diproses || 0, bg: 'from-orange-500 to-orange-600', anim: 'animate-spin group-hover:scale-110 group-hover:opacity-100' },
